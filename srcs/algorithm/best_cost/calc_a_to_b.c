...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/16 20:38:02 by psegura-          #+#    #+#             */
/*   Updated: 2024/03/16 21:23:52 by psegura-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	locate_cheapest_a_to_b(t_stack **a, t_stack **b, t_info *info)
{
...
{
	set_target_and_dist_a(a, b, info);
	locate_cheapest_a_to_b(a, b, info);
}
